                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="darkMode">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control form-control-sm" name="sidebar_post_random_status">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="sidebar_top_author_status">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="sidebar_tag_status">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="sidebar_top_postview_status">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="user_add_post_status">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select  class="form-control form-control-sm" name="user_login_register_status">
                                                    ...
                                                    <div class="form-group ">
                                                        <label for="comment_approved_required" class=" col-form-label ">Phê duyệt bình luận của thành viên</label>
                                                        <select  class="form-control form-control-sm" name="comment_approved_required">
                                                            <option  {{setting()->comment_approved_required==1?'selected':''}} value="1">Bật</option>
                                                            <option  {{setting()->comment_approved_required==0?'selected':''}} value="0">Tắt</option>
                                                        </select>
                                                    </div>
